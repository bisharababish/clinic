    ...
    const markPaymentCompleted = async (paymentId: string) => {
        try {
            ...
            if (paymentBooking) {
                ...
                let clinic: { id: string; name: string; name_ar: string; } | null = null;
                let clinicError: Error | null = null;
                ...
                let doctor: { id: string; name: string; name_ar: string; } | null = null;
                let doctorError: Error | null = null;
                ...
                if (clinic && doctor) {
                    ...
                    let newAppointment: { id: string; } | null = null;
                    let appointmentError: Error | null = null;
