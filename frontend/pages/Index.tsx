...
const Index = () => {
  ...
  const currentPatients = searchResults.slice(startIndex, endIndex);
  ...
  return (
    <>
      <SEOHead
        title="Patient Health Information - Bethlehem Medical Center"
        description="Manage patient health information, medical records, and health data at Bethlehem Medical Center. Comprehensive healthcare management system for medical professionals."
        keywords="patient health information, medical records, healthcare management, Bethlehem Medical Center, patient data, health records"
        url="https://bethlehemmedcenter.com/home"
      />
                  ...
                  <div className="mt-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-600">
                        ...
                        <span className="flex items-center gap-1">
                          <AlertCircle className="h-4 w-4" />
                          {searchResults.filter(p => !p.health_data).length} {isRTL ? "بدون بيانات" : "no data"}
                        </span>
                      </div>
                    </div>
