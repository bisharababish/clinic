                                    ...
                                    {category.parts.map((part) => (
                                        <button
                                            ...
                                            className={`px-3 py-2 text-sm rounded-md transition-colors duration-200 text-left ${isPartSelected(part.value)
                                                ? 'bg-[#377fa8]/20 text-[#377fa8] border border-[#377fa8]/30'
            ...
            {selectedBodyParts.length > 0 && (
                <div className="mt-6 text-center">
                    <div className="space-y-2">
                        <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-[#377fa8]/20 text-[#377fa8] border border-[#377fa8]/30">
