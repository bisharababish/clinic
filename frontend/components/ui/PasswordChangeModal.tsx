...
export function PasswordChangeModal({
    ...
    const performPasswordChange = async (userEmail: string, currentPassword: string, newPassword: string, isRTL: boolean, toast: ReturnType<typeof useToast>['toast']) => {
        try {
            ...
            try {
                ...
                if (dbResult.error) {
                    console.warn('⚠️ Failed to update password in userinfo table (non-critical):', dbResult.error);
                } else {
