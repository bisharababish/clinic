...
// Custom X-Ray Icon Component
export const XRayIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
    <svg 
        id="Layer_1" 
        data-name="Layer 1" 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 90.26 122.88"
        className={className}
    >
        <defs>
