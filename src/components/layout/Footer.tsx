    ...
    <footer className="w-full bg-gradient-to-b from-background to-muted/10 border-t shadow-sm" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          {/* Developed by Codefusion.me Section - moved below copyright */}
          <div className="developed-by flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mt-8 w-full">
            <a
