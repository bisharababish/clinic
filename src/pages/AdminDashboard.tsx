// pages/AdminDashboard.tsx (Enhanced Version)
...
const AdminDashboard = () => {
    ...
    const [userStats, setUserStats] = useState<UserStats>({ total: 0, byRole: {}, recentUsers: [] });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (formMode === "create") {
                ...
                // First create the Supabase auth user for non-patients
                ...
                <TabsContent value="overview" className="pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">All Systems OK</div>
                            </CardContent>
                        </Card>
                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select defaultValue="8am-6pm">
                                            ...
                                            <SelectContent>
                                                <SelectItem value="8am-6pm">8 AM - 6 PM</SelectItem>
                                                <SelectItem value="9am-7pm">9 AM - 7 PM</SelectItem>
                                                <SelectItem value="7am-5pm">7 AM - 5 PM</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-0.5">
                                            <Label htmlFor="email-reminders">Email Appointment Reminders</Label>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-0.5">
                                            <Label htmlFor="report-alerts">Daily Activity Reports</Label>
                                            <p className="text-sm text-gray-500">Receive daily email reports of clinic activity</p>
                                        </div>
                                        <Input
                                            id="report-alerts"
                                            type="checkbox"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Minimum 8 characters, with uppercase, lowercase, and numbers</p>
                                    </div>
