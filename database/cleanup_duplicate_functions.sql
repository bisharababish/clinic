-- CLEANUP: Remove duplicate functions and keep only BIGINT versions
-- Run this in your Supabase SQL Editor to fix the function ambiguity error

-- =====================================================
-- 1. DROP OLD INTEGER VERSIONS OF FUNCTIONS
-- =====================================================

-- Drop old INTEGER versions if they exist
...
-- =====================================================
-- 2. CREATE CLEAN BIGINT VERSIONS
-- =====================================================

-- Create check_user_dependencies function with BIGINT
...
-- Create delete_user_and_auth_completely function with BIGINT
...
-- Check that only BIGINT versions exist
SELECT routine_name, routine_type, data_type 
FROM information_schema.routines 
WHERE routine_schema = 'public' 
AND routine_name LIKE '%check_user_dependencies%' 
ORDER BY routine_name;

-- Test with a user ID (replace with actual userid)
