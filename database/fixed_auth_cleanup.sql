-- FIXED AUTH CLEANUP - DROPS OLD FUNCTIONS FIRST
-- This fixes the parameter name conflict error
-- Run this in your Supabase SQL Editor

-- =====================================================
-- 1. DROP ALL EXISTING AUTH DELETION FUNCTIONS
-- =====================================================

DROP FUNCTION IF EXISTS public.delete_auth_user_by_email(TEXT);
DROP FUNCTION IF EXISTS public.delete_auth_user_by_id(UUID);
DROP FUNCTION IF EXISTS public.delete_orphaned_auth_users();
DROP FUNCTION IF EXISTS public.delete_auth_user_by_email(text);
DROP FUNCTION IF EXISTS public.delete_auth_user_by_id(uuid);

-- =====================================================
-- 2. CHECK WHICH USERS NEED AUTH CLEANUP
-- =====================================================
...
-- =====================================================
-- 3. CREATE FUNCTION TO DELETE AUTH USER BY EMAIL
-- =====================================================
...
-- =====================================================
-- 4. CREATE FUNCTION TO DELETE AUTH USER BY ID
-- =====================================================
...
-- =====================================================
-- 5. CREATE FUNCTION TO DELETE ALL ORPHANED AUTH USERS
-- =====================================================
...
-- =====================================================
-- 7. IMMEDIATE CLEANUP - DELETE ORPHANED AUTH USERS
-- =====================================================

-- This will automatically delete all users that were removed from userinfo but still exist in auth.users
...
-- Check if any orphaned auth users remain (should return empty)
